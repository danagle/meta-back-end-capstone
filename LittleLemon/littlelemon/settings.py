...
SECRET_KEY = 'django-insecure-2m(p3(0#^%9$w)jmvna5cqmz7r_p2pj%xzgzx_r4&cwd$!q9p='
...
mysql_config = BASE_DIR.parent / 'my.env'
assert(Path(mysql_config).is_file())
load_dotenv(mysql_config)
